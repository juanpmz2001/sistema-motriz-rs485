...
| Iteration C — traction qualification | **IN PROGRESS** | Rafa now provides repeatable read-only RS485/SVD48/PPM evidence and a preliminary bounded M1 controller response. M1/M2 physical side/sign correlation, coherent individual low-speed evidence and all generic L4/L5 gates remain open; see [Rafa bench state](robots/RAFA_BENCH_STATE.md). |
