...
requires two configured controllers; the single-motor build profile therefore fails
safe during legacy runtime construction until that driver is separated.
