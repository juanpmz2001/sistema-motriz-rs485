...
Historical generator note: official SV-Config XML later confirmed `0x5408/09`
as MOS temperature, `0x540C/0D` as bus voltage, and `0x5410/11` as signed
`0.1 RPM`. The four affected display labels below were corrected while retaining
their original addresses/raw words.

- Captured: `2026-07-21T05:15:20.953268+00:00`
...
| motor_electrical | m1_lq | 0x5000 x2 | float32_words | OK | 0x3981 0xB577 |
| motor_electrical | m2_lq | 0x5002 x2 | float32_words | OK | 0x397E 0x9821 |
| motor_electrical | m1_ld | 0x5008 x2 | float32_words | OK | 0x3981 0xB577 |
| motor_electrical | m2_ld | 0x500A x2 | float32_words | OK | 0x397E 0x9821 |
| motor_electrical | m1_rs | 0x5010 x2 | float32_words | OK | 0x3DF3 0xEAB3 |
| motor_electrical | m2_rs | 0x5012 x2 | float32_words | OK | 0x3E06 0x3F14 |
| motor_general | m1_pole_pairs | 0x5018 x1 | u16 | OK | 0x000A |
| motor_general | m2_pole_pairs | 0x5019 x1 | u16 | OK | 0x000A |
| motor_general | m1_max_speed_rpm | 0x501C x1 | u16 | OK | 0x000A |
| motor_general | m2_max_speed_rpm | 0x501D x1 | u16 | OK | 0x000A |
...
| motion_config | m1_max_acceleration_rpm_s | 0x5108 x1 | u16 | OK | 0x0003 |
| motion_config | m2_max_acceleration_rpm_s | 0x5109 x1 | u16 | OK | 0x0003 |
| motion_config | m1_max_deceleration_rpm_s | 0x510C x1 | u16 | OK | 0x0003 |
| motion_config | m2_max_deceleration_rpm_s | 0x510D x1 | u16 | OK | 0x0003 |
...
| telemetry | m1_mos_temperature_dc | 0x5408 x1 | i16 | OK | 0x00E3 |
| telemetry | m2_mos_temperature_dc | 0x5409 x1 | i16 | OK | 0x00E4 |
...
| telemetry | m1_position | 0x5418 x2 | i32 | OK | 0x0000 0x0000 |
| telemetry | m2_position | 0x541A x2 | i32 | OK | 0x0000 0x0000 |
...
| encoder | m1_encoder_bias_deg | 0x550C x1 | u16 | OK | 0x002A |
| encoder | m2_encoder_bias_deg | 0x550D x1 | u16 | OK | 0x0028 |
...
| hall | m1_angle_table | 0x5640 x8 | i16[8] | OK | 0x0000 0x002C 0x0066 0x00A4 0x00E0 0x011A 0x0159 0x0000 |
| hall | m2_angle_table | 0x5650 x8 | i16[8] | OK | 0x0000 0x0028 0x0063 0x00A2 0x00DC 0x0117 0x0157 0x0000 |
...
| hall | m1_hall_status | 0x5688 x1 | u16 | OK | 0x0000 |
| hall | m2_hall_status | 0x5689 x1 | u16 | OK | 0x0000 |
| hall | m1_current_angle_deg | 0x568C x1 | u16 | OK | 0x0059 |
| hall | m2_current_angle_deg | 0x568D x1 | u16 | OK | 0x0149 |
